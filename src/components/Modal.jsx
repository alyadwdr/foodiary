...
export default function Modal({ open, onClose, title, children, size = 'md' }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-4">
      ...
      <div className={`relative w-full ${sizes[size]} bg-white rounded-3xl shadow-float animate-in`}>
        <div className="flex items-center justify-between px-6 py-5 border-b border-cream/60">
